...
class TestAnalyse(unittest.TestCase):
    ...
    def test_final_dicts(self):
        ...
        self.assertDictEqual(self.analyse_NaCl_distorted.final_dict_bonds, {
            'Na-Cl': {'number_of_bonds': 18, 'ICOHP_sum': -10.21, 'has_antbdg': True,
                      'ICOHP_mean': -0.5672222222222223}})
        self.assertDictEqual(self.analyse_NaCl_spin.final_dict_bonds, {
            'Na-Cl': {'number_of_bonds': 6, 'ICOHP_sum': -3.39, 'has_antbdg': True, 'ICOHP_mean': -0.5650000000000001}})
