...
class TestAnalyse(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.analyse_BaTaO2N1_cutoff = Analysis(path_to_poscar="TestData/BaTaO2N1/POSCAR.gz",
                                         path_to_cohpcar="TestData/BaTaO2N1/COHPCAR.lobster.gz",
                                         path_to_icohplist="TestData/BaTaO2N1/ICOHPLIST.lobster.gz",
                                         path_to_charge="TestData/BaTaO2N1/CHARGE.lobster.gz",
                                         whichbonds="all", \
    ...
    def test_all_attributes_NaCl_Mulliken(self):
        ...
        self.assertAlmostEqual(
            float(self.analyse_NaCl.condensed_bonding_analysis["sites"][0]["bonds"]["Cl"]["ICOHP_mean"]), -0.57)
        self.assertAlmostEqual(
            float(self.analyse_NaCl.condensed_bonding_analysis["sites"][0]["bonds"]["Cl"]["ICOHP_sum"]), -3.39)
        self.assertEqual(
    ...
    def test_all_attributes_NaCl_valences(self):
        ...
        self.assertAlmostEqual(self.analyse_NaCl_valences.condensed_bonding_analysis["max_considered_bond_length"],
                               5.69169)
        self.assertAlmostEqual(self.analyse_NaCl_valences.condensed_bonding_analysis["number_of_considered_ions"], 1)
        ...
        self.assertAlmostEqual(
            ...
            -0.57)
        self.assertAlmostEqual(
            float(self.analyse_NaCl_valences.condensed_bonding_analysis["sites"][0]["bonds"]["Cl"]["ICOHP_sum"]), -3.39)
        self.assertEqual(self.analyse_NaCl_valences.condensed_bonding_analysis["sites"][0]["bonds"]["Cl"][
                             "has_antibdg_states_below_Efermi"], True)
        self.assertEqual(
            self.analyse_NaCl_valences.condensed_bonding_analysis["sites"][0]["bonds"]["Cl"]["number_of_bonds"], 6)
        self.assertEqual(self.analyse_NaCl_valences.condensed_bonding_analysis["sites"][0]["ion"], "Na")
        self.assertAlmostEqual(self.analyse_NaCl_valences.condensed_bonding_analysis["sites"][0]["charge"], 1)
        self.assertListEqual(self.analyse_NaCl_valences.condensed_bonding_analysis["sites"][0]["relevant_bonds"],
                             ['21', '23', '24', '27', '28', '30'])
    ...
    def test_all_attributes_BaTiO3(self):
        ...
        self.assertAlmostEqual(self.analyse_BaTiO3.condensed_bonding_analysis["max_considered_bond_length"],
                               5.94882)
        self.assertAlmostEqual(
            self.analyse_BaTiO3.condensed_bonding_analysis["number_of_considered_ions"], 1)
    ...
    def test_all_attributes_NaCl_all(self):
        ...
        self.assertEqual(self.analyse_NaCl_all.condensed_bonding_analysis["formula"], "NaCl")
        self.assertAlmostEqual(self.analyse_NaCl_all.condensed_bonding_analysis["max_considered_bond_length"], 5.69169)
        self.assertAlmostEqual(self.analyse_NaCl_all.condensed_bonding_analysis["number_of_considered_ions"], 2)
        ...
        self.assertAlmostEqual(
            float(self.analyse_NaCl_all.condensed_bonding_analysis["sites"][0]["bonds"]["Cl"]["ICOHP_mean"]), -0.57)
        self.assertAlmostEqual(
            float(self.analyse_NaCl_all.condensed_bonding_analysis["sites"][0]["bonds"]["Cl"]["ICOHP_sum"]), -3.39)
        self.assertEqual(
            self.analyse_NaCl_all.condensed_bonding_analysis["sites"][0]["bonds"]["Cl"][
                "has_antibdg_states_below_Efermi"],
            True)
        self.assertEqual(self.analyse_NaCl_all.condensed_bonding_analysis["sites"][0]["bonds"]["Cl"]["number_of_bonds"],
                         6)
        ...
        self.assertListEqual(self.analyse_NaCl_all.condensed_bonding_analysis["sites"][0]["relevant_bonds"],
                             ['21', '23', '24', '27', '28', '30'])
        self.assertEqual(self.analyse_NaCl_all.condensed_bonding_analysis["type_charges"], "Mulliken")

    def test_final_dicts(self):
        self.assertAlmostEqual(self.analyse_NaSi_madelung_all.final_dict_bonds["Na-Si"]["ICOHP_mean"],-0.44833333333)
        ...
        self.assertAlmostEqual(self.analyse_NaCl.final_dict_bonds['Cl-Na']['ICOHP_mean'], -0.565000000000000)
        ...
        self.assertAlmostEqual(self.analyse_BaTiO3.final_dict_bonds['O-Ti']['ICOHP_mean'], -3.5399999999999996)
        ...
        self.assertAlmostEqual(self.analyse_NaCl_distorted.final_dict_bonds['Cl-Na']['ICOHP_mean'], -0.5658333333333334)
        self.assertEqual(self.analyse_NaCl_spin.final_dict_bonds['Cl-Na']["has_antbdg"], True)
        self.assertAlmostEqual(self.analyse_NaCl_spin.final_dict_bonds['Cl-Na']['ICOHP_mean'], -0.5650000000000001)
        self.assertDictEqual(self.analyse_NaCl_spin.final_dict_ions, {'Na': {'O:6': 1}})
        self.assertAlmostEqual(self.analyse_NaCl_all.final_dict_bonds['Cl-Na']['ICOHP_mean'], -0.5650000000000001)
