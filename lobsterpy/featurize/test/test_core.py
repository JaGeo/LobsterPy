...
class TestFeaturizeLobsterpy(unittest.TestCase):
    def setUp(self):
        ...
        self.featurize_mp1249_json = FeaturizeLobsterpy(path_to_json=TestDir / "TestData/JSONS/mp-1249.json.gz",
                        bonds='all_bonds')
        self.featurize_mp1958_json = FeaturizeLobsterpy(path_to_json=TestDir / "TestData/JSONS/mp-1958.json.gz",
                                                        bonds='all_bonds')
        self.featurize_mp14652_json = FeaturizeLobsterpy(path_to_json=TestDir / "TestData/JSONS/mp-14652.json.gz",
                                                        bonds='all_bonds')
    ...
    def test_featurize_mp1249_json(self):
        ...
        self.assertAlmostEqual(
            df.loc['mp-1249', "Icohp_mean_avg"], -1.020000, places=5
        )
        self.assertAlmostEqual(
            df.loc['mp-1249', "Icohp_mean_max"], -1.020000, places=5
        )
        self.assertAlmostEqual(
            df.loc['mp-1249', "Icohp_mean_min"], -1.020000, places=5
        )
        self.assertAlmostEqual(
            df.loc['mp-1249', "Icohp_mean_std"], 0.000000, places=5
        )
        self.assertAlmostEqual(
            df.loc['mp-1249', "Madelung_Mull"], -52.000000, places=5
        )
        self.assertAlmostEqual(
    ...
    def test_featurize_mp1958_json(self):
        ...
        self.assertAlmostEqual(
            df.loc['mp-1958', "Madelung_Loew"], -16.68000, places=5
        )
        self.assertAlmostEqual(
    ...
    def test_featurize_mp14652_json(self):
        ...
        # Test that all the values in the DataFrame
        self.assertAlmostEqual(
            df.loc['mp-14652', "Icohp_mean_std"], 2.335070, places=5
        )
        self.assertAlmostEqual(
