...
class TestDescribe:
    def test_coordination_environment_to_text(self):
        results_dict = {
            ...
            "FO:7": "face-capped octahedral (CN=7)",
            "C:8": "cubic (CN=8)",
            ...
            "DD:8": "dodecahedral with triangular faces (CN=8)",
            "DDPN:8": "dodecahedron with triangular faces - p2345 plane normalized (CN=8)",
            ...
            "TT_3:9": "tricapped triangular prismatic (one square-face cap and two triangular-face caps) (CN=9)",
            "HD:9": "heptagonal dipyramidal (CN=9)",
            "TI:9": "tridiminished icosahedral (CN=9)",
            "SMA:9": "square-face monocapped antiprismatic (CN=9)",
            ...
            "TO_3:9": "tricapped octahedral (all 3 cap faces are sharingone edge of a face) (CN=9)",
            ...
            "BS_2:10": "bicapped square prismatic (adjacent faces) (CN=10)",
            ...
            "DI:11": "diminished icosahedral (CN=11)",
    ...
    def test_msonable(self, describe_nacl, describe_cdf):
        ...
        initialize_description = Description.from_dict(msonable_dict)
        assert describe_nacl.text == initialize_description.text

        msonable_dict_2 = describe_cdf.as_dict()
        initialize_description_2 = Description.from_dict(msonable_dict_2)
        assert describe_cdf.text == initialize_description_2.text
