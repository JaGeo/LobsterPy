...
class TestGraph:
    ...
    def test_graph_nacl_all(self):
        ...
        assert self.graph_nacl_all.sg.graph.nodes(data=True)[0]["coords"].tolist() == [
            0.0,
            0.0,
            0.0,
        ]
        ...
        assert (
            self.graph_nacl_all.sg.graph.nodes(data=True)[0]["properties"]["env"]
            == "O:6"
        )

        assert self.graph_nacl_all.sg.graph.nodes(data=True)[1]["specie"] == "Cl"
        assert self.graph_nacl_all.sg.graph.nodes(data=True)[1]["coords"].tolist() == [
            2.845847,
            2.845847,
            2.845847,
        ]
        ...
        assert (
            self.graph_nacl_all.sg.graph.nodes(data=True)[1]["properties"]["env"]
            == "O:6"
        )

        assert self.graph_nacl_all.sg.graph.get_edge_data(0, 1)[0][
            "ICOHP"
        ...
        assert self.graph_nacl_all.sg.graph.get_edge_data(0, 1)[4][
            "ICOHP"
        ] == pytest.approx(-0.5661, abs=0.001)
        assert (
            self.graph_nacl_all.sg.graph.get_edge_data(0, 1)[4]["ICOHP_bonding_perc"]
            == 1
        )
        assert (
    ...
    def test_graph_nacl_cation_anion(self):
        ...
        assert self.graph_nacl_cation_anion.sg.graph.nodes(data=True)[0][
            "coords"
        ].tolist() == [0.0, 0.0, 0.0]
        assert (
        ...
        assert self.graph_nacl_cation_anion.sg.graph.nodes(data=True)[1][
            "coords"
        ].tolist() == [
            2.845847,
            2.845847,
        ...
        assert (
            "env"
            not in self.graph_nacl_cation_anion.sg.graph.nodes(data=True)[1][
                "properties"
            ]
        )

        assert self.graph_nacl_cation_anion.sg.graph.get_edge_data(0, 1)[0][
            "ICOHP"
        ] == pytest.approx(-0.5661, abs=0.001)
        assert (
        ...
        assert self.graph_nacl_cation_anion.sg.graph.get_edge_data(0, 1)[4][
            "ICOHP"
    ...
    def test_graph_nacl_without_add_data(self):
        ...
        assert self.graph_nacl_without_add_data.sg.graph.nodes(data=True)[0][
            "coords"
        ].tolist() == [0.0, 0.0, 0.0]
        assert (
        ...
        assert self.graph_nacl_without_add_data.sg.graph.nodes(data=True)[1][
            "coords"
        ].tolist() == [
            2.845847,
            2.845847,
        ...
        assert self.graph_nacl_without_add_data.sg.graph.get_edge_data(0, 1)[0][
            "ICOHP"
        ] == pytest.approx(-0.5661, abs=0.001)
        assert (
        ...
        assert (
            "ICOBI"
            not in self.graph_nacl_without_add_data.sg.graph.get_edge_data(0, 1)[0]
        )
        assert (
            "ICOOP"
            not in self.graph_nacl_without_add_data.sg.graph.get_edge_data(0, 1)[0]
        ...
        assert self.graph_nacl_without_add_data.sg.graph.get_edge_data(0, 1)[4][
            "ICOHP"
        ] == pytest.approx(-0.5661, abs=0.001)
        assert (
        ...
        assert (
            "ICOBI"
            not in self.graph_nacl_without_add_data.sg.graph.get_edge_data(0, 1)[4]
        )
        assert (
            "ICOOP"
            not in self.graph_nacl_without_add_data.sg.graph.get_edge_data(0, 1)[4]
    ...
    def test_graph_nacl_close_fermi(self):
        ...
        assert self.graph_nacl_close_fermi.sg.graph.nodes(data=True)[0][
            "coords"
        ].tolist() == [0.0, 0.0, 0.0]
        assert (
        ...
        assert self.graph_nacl_close_fermi.sg.graph.nodes(data=True)[1][
            "coords"
        ].tolist() == [
            2.845847,
            2.845847,
        ...
        assert self.graph_nacl_close_fermi.sg.graph.get_edge_data(0, 1)[0][
            "ICOHP"
        ] == pytest.approx(-0.5661, abs=0.001)
        assert (
        ...
        assert (
            "ICOBI" not in self.graph_nacl_close_fermi.sg.graph.get_edge_data(0, 1)[0]
        )
        assert (
            "ICOOP" not in self.graph_nacl_close_fermi.sg.graph.get_edge_data(0, 1)[0]
        )
        assert (
        ...
        assert self.graph_nacl_close_fermi.sg.graph.get_edge_data(0, 1)[4][
            "ICOHP"
        ] == pytest.approx(-0.5661, abs=0.001)
        assert (
        ...
        assert (
            "ICOBI" not in self.graph_nacl_close_fermi.sg.graph.get_edge_data(0, 1)[4]
        )
        assert (
            "ICOOP" not in self.graph_nacl_close_fermi.sg.graph.get_edge_data(0, 1)[4]
        )
        assert (
    ...
    def test_graph_cdf_all(self):
        ...
        assert self.graph_cdf_all.sg.graph.nodes(data=True)[0]["coords"].tolist() == [
            0.0,
            0.0,
            0.0,
        ]
        ...
        assert (
            self.graph_cdf_all.sg.graph.nodes(data=True)[0]["properties"]["env"]
            == "C:8"
        )

        assert self.graph_cdf_all.sg.graph.nodes(data=True)[1]["specie"] == "F"
        assert self.graph_cdf_all.sg.graph.nodes(data=True)[1]["coords"].tolist() == [
            1.37314,
            1.37314,
            1.37314,
        ]
        ...
        assert (
            self.graph_cdf_all.sg.graph.nodes(data=True)[1]["properties"]["env"]
            == "T:4"
        )
        ...
        assert (
            self.graph_cdf_all.sg.graph.get_edge_data(0, 1)[0]["ICOHP_antibonding_perc"]
            == 0.27737
        )
        ...
        assert (
            self.graph_cdf_all.sg.graph.get_edge_data(0, 1)[3]["ICOHP_antibonding_perc"]
            == 0.27737
        )
    ...
    def test_graph_cdf_close_fermi(self):
        ...
        assert self.graph_cdf_close_fermi.sg.graph.nodes(data=True)[0][
            "coords"
        ].tolist() == [0.0, 0.0, 0.0]
        assert (
        ...
        assert (
            self.graph_cdf_close_fermi.sg.graph.nodes(data=True)[0]["properties"]["env"]
            == "C:8"
        )

        assert self.graph_cdf_close_fermi.sg.graph.nodes(data=True)[1]["specie"] == "F"
        assert self.graph_cdf_close_fermi.sg.graph.nodes(data=True)[1][
            "coords"
        ...
        assert (
            self.graph_cdf_close_fermi.sg.graph.nodes(data=True)[1]["properties"]["env"]
            == "T:4"
        )
        ...
        assert (
            self.graph_cdf_close_fermi.sg.graph.get_edge_data(0, 1)[0]["ICOBI"]
            == 0.08932
        )
        assert (
            self.graph_cdf_close_fermi.sg.graph.get_edge_data(0, 1)[0]["ICOOP"]
            == 0.0148
        )
        assert (
        ...
        assert (
            self.graph_cdf_close_fermi.sg.graph.get_edge_data(0, 1)[3]["ICOBI"]
            == 0.08932
        )
        assert (
            self.graph_cdf_close_fermi.sg.graph.get_edge_data(0, 1)[3]["ICOOP"]
            == 0.0148
        )
        assert (
